...
**Phase 2: Write Path (Sequential)** 3. **Story 2.3** (ILP Packet Construction) — 20 hours (2.5 days)

**Phase 3: Server-Side Processing (Sequential)** 4. **Story 2.4** (BLS Handler) — 24 hours (3 days) — **HIGHEST RISK, PAIR REQUIRED**

**Phase 4: Verification & Compliance (Sequential)** 5. **Story 2.5** (Identity Propagation) — 16 hours (2 days) 6. **Story 2.6** (Fee Collection) — 12 hours (1.5 days)
