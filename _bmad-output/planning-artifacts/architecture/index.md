...
- [BitCraft AI-Native Agent SDK — Architecture Document](#table-of-contents)
  ...
  - [7. Crosstown Integration](./7-crosstown-integration.md)
    - [7.1 CrosstownClient Usage (`@crosstown/client`)](./7-crosstown-integration.md#71-crosstownclient-usage-crosstownclient)
    - [7.2 BLS Game Action Handler (`@crosstown/sdk`)](./7-crosstown-integration.md#72-bls-game-action-handler-crosstownsdk)
