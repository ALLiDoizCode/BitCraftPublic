...
**Requirement:** Monorepo setup → root configs exist → ESLint (.eslintrc.cjs), Prettier (.prettierrc), .env.example → .gitignore excludes node_modules/, target/, .env, dist/, build/, *.tsbuildinfo, .turbo/, *.local, coverage/
